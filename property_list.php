...
if (!$city) {
    echo "Sorry! We do not have any PGs/Hostels And Houses listed in this city.";
    return;
}
$city_id = $city['id'];
...
<head>
    ...
    <title>Best Houses in <?php echo $city_name ?> | HOUSEHUNT</title>
    ...
    <div class="page-container">
        ...
        ?>
            <div class="no-property-container">
                <p>No PGs/Hostels And Houses to list</p>
            </div>
        <?php
        }  
        ?>
